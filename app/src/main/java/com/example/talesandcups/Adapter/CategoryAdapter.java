...
public class CategoryAdapter extends RecyclerView.Adapter<CategoryAdapter.viewHolder> {
    ...
    public void onBindViewHolder(@NonNull CategoryAdapter.viewHolder holder, int position) {
        ...
        switch(position) {
            case 0: {
                holder.categoryImage.setBackgroundResource(R.drawable.pizza);
                break;
            }
            case 1: {
                holder.categoryImage.setBackgroundResource(R.drawable.burgar);
                break;
            }
            case 2: {
                holder.categoryImage.setBackgroundResource(R.drawable.chicken);
                break;
            }
            case 3: {
                holder.categoryImage.setBackgroundResource(R.drawable.sushi);
                break;
            }
            case 4: {
                holder.categoryImage.setBackgroundResource(R.drawable.mutton);
                break;
            }
            case 5: {
                holder.categoryImage.setBackgroundResource(R.drawable.hot_dog);
                break;
            }
            case 6: {
                holder.categoryImage.setBackgroundResource(R.drawable.drink);
                break;
            }
            case 7: {
                holder.categoryImage.setBackgroundResource(R.drawable.others);
                break;
            }
        }
